...
namespace ArtifactOfDoom
{
    ...
    //     public static MiniRpcLib.Func.IRpcFunc<string, string> AddGainedItemsToPlayers { get; set; }
    //     public static MiniRpcLib.Func.IRpcFunc<string, string> AddLostItemsOfPlayers { get; set; }
    //     public static MiniRpcLib.Func.IRpcFunc<string, string> UpdateProgressBar { get; set; }
    //     public static MiniRpcLib.Func.IRpcFunc<bool, string> IsArtifactActive { get; set; }
    //     public static MiniRpcLib.Func.IRpcFunc<bool, string> IsCalculationSacrifice { get; set; }
